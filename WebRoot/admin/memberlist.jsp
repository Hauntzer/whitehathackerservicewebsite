...
<html lang="en">
  ...
  <body class="">
    ...
    <%	 CommDAO dao = new CommDAO(); 
	 String sql = "select * from member where 1=1  and delstatus=0 and utype='白帽'";
	 String url = "/whitehathackerservicewebsite/admin/memberlist.jsp?1=1";
