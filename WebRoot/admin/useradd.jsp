...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="/whitehathackerservicewebsite/whitehathackerservicewebsite?ac=useradd" method="post">
		        <label>用户名</label>
  ...
  <div class="modal-footer">
    ...
    <script type="text/javascript">
        ...
        function validatorloginName(){     
       	 ...
       	 $.ajax({  
       	        type: "POST",      
       	         url: "/whitehathackerservicewebsite/whitehathackerservicewebsite?ac=usernamecheck", //servlet的名字     
