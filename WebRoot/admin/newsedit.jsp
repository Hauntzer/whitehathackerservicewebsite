...
<html lang="en">
  <head>
	...
	<script charset="utf-8" src="/whitehathackerservicewebsite/kindeditor/kindeditor.js"></script>
	<script charset="utf-8" src="/whitehathackerservicewebsite/kindeditor/lang/zh-CN.js"></script>
	<script>
...
uploadJson : '/whitehathackerservicewebsite/kindeditor/jsp/upload_json.jsp',

                fileManagerJson : '/whitehathackerservicewebsite/kindeditor/jsp/file_manager_json.jsp',
...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="/whitehathackerservicewebsite/whitehathackerservicewebsite?ac=newsedit&id=<%=id %>" method="post" enctype="multipart/form-data">
		        <label>标题</label>
