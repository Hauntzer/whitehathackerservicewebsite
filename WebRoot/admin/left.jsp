  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <ul id="dashboard-menu" class="nav nav-list collapse in">
            ...
            <li><a href="admin/memberlist.jsp">白帽管理</a></li>
            <li><a href="admin/member2list.jsp">厂商管理</a></li>
...
<!-- <span class="label label-info">+3</span> -->
        ...
        <ul id="accounts-menu" class="nav nav-list collapse in">
            <li><a href="admin/projects.jsp">项目管理</a></li>
            <li><a href="admin/baogaos.jsp">报告管理</a></li>
        </ul>
