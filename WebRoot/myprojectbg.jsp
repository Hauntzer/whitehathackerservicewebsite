	...
	<div id="page-content" class="single-page">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<ul class="breadcrumb">
						<li><a href="myprojects.jsp">项目报告</a></li>
					</ul>
				</div>
			</div>
			...
			String sql = "select * from baogao where pid in (select id from projects where uid='"+membersession.get("id")+"') order by id desc";
			String url ="/whitehathackerservicewebsite/myprojectbg.jsp?1=1";
		    ...
		    ArrayList<HashMap> prolist=(ArrayList)bean.getCollection();
				for(HashMap bgmap:prolist){ 
					...
					HashMap bmmap = dao.select("select * from member where id="+bgmap.get("uid")).get(0);
			%>
				<div class="product well">
					<div class="col-md-9">
						...
						<div class="caption">
							<div class="name">提交人：<%=bmmap.get("tname") %></div>
						</div>
						<div class="caption">
							<div class="name">提交日期：<%=bgmap.get("savetime") %></div>
						</div>
						<div class="info">	
              				<a href="myprojectbg.jsp?did=<%=promap.get("id") %>" ><i class="icon-remove"></i>删除</a>
						</div>
